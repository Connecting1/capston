// lib/screens/first_reflection_screen.dart
import 'package:flutter/material.dart';
import '../services/api_service.dart';
import '../services/speech_service.dart';
import 'dart:async';

class FirstReflectionScreen extends StatefulWidget {
  final String concept;
  final String roomId;
  final String explanation;
  

  const FirstReflectionScreen({
    Key? key,
  ...
  @override
  _FirstReflectionScreenState createState() => _FirstReflectionScreenState();
}
...
class _FirstReflectionScreenState extends State<FirstReflectionScreen>
  ...
  Future<void> _submitWithText(String text) async {
    ...
    try {
      await ApiService.saveMessage(widget.roomId, text, 'self_reflection_1');  // phase 주의
