// lib/screens/second_reflection_screen.dart
import 'package:flutter/material.dart';
import '../services/api_service.dart';
import '../services/speech_service.dart';
import 'dart:async';

class SecondReflectionScreen extends StatefulWidget {
  ...
  @override
  _SecondReflectionScreenState createState() => _SecondReflectionScreenState();
}

class _SecondReflectionScreenState extends State<SecondReflectionScreen>
  ...
  Future<void> _submitWithText(String text) async {
    ...
    try {
      await ApiService.saveMessage(widget.roomId, text, 'self_reflection_2');
      ...
      Navigator.pushReplacementNamed(
        ...
        arguments: {
          ...
          'firstExplanation': widget.firstExplanation,
          'firstReflection': widget.firstReflection,
          'secondExplanation': widget.secondExplanation,
          'secondReflection': text,
        },
      );
    } catch (e) {
      print('Error: $e');
                          ...
                          children: [
                            ...
                            if (_isRecording)
                              Padding(
                                ...
                                child: Text(
                                  '🎤 ${_recognizedText.isEmpty ? "말씀하세요..." : _recognizedText}',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.red,
                                    fontWeight: FontWeight.bold,
